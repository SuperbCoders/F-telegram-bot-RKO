    ...
    def getResult(self):
        ...
        for lr_persons in lr_list_companyPersons:
            ...
            roles = self.getRoles(
                ...
                founderShare=lr_persons['account_own_piece'] if "account_own_piece" in lr_persons else 0,
                beneficiaryShare=lr_persons['account_own_piece'] if "account_own_piece" in lr_persons else 0,
            )
