<template>
  <div class="purposes_block">
    ...
    <div @click="valid = true" class="form_block">
      ...
      <v-checkbox v-model="currentData.account_operations" label="Дистанцинное обслуживание" value="Дистанцинное обслуживание" hide-details></v-checkbox>
      ...
      <v-checkbox v-model="currentData.account_operations" label="Переводы СБП (c2b)" color="red" value="red" hide-details></v-checkbox>
    </div>
