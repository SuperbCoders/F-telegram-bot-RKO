<template>
  <div class="document_section">
    ...
    <v-btn block large class="mt-10 auth_form_bth" color="primary" :disabled="currentData.first_passport_page === null"
      @click="redirect()">Продолжить
    </v-btn>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async redirect() {
      ...
      this.$store.commit("setPersone", { key: "substep_7", value: this.currentData });


      this.$router.push({ name: "substep_8" });
    }
  },
