        ...
        list: [
          {
            id: 1,
            value:
              "Компания является финансовым институтом в соответствии с законом США о налогообложении иностранных счетов (FATCA) и/или главой 20.1",
          },
          {
            id: 2,
            value:
          ...
          },
          {
            id: 4,
            value:
              "Компания осуществляет виды деятельности, которые могут иметь стратегическое значение для оборонно промышленного комплекса и безопасноти РФ",
          },
          {
            id: 5,
            value:
              "Компания не относиться к указанным в настоящем пунтке юридическим лицам",
          },
        ],
      },
      list: [
        ...
        },
        {
          id: 4,
          value:
            "Компания осуществляет виды деятельности, которые могут именить стратегическое значение для оборонно промышленного комплекса и безопасноти РФ",
        },
        {
          id: 5,
          value:
